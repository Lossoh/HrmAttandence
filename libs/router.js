...
module.exports = function (app, tfa, passport, login) {
    ...
    var atten = require('./router/atten')(app, tfa, passport, login);
    var geo = require('./router/geo')(app, tfa, passport, login);
    var fenece = require('./router/fenece')(app, tfa, passport, login);
